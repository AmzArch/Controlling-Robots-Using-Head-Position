...
# file that should have been included as part of this package.
    ...
    def send_to_robot(self,pos):
        ...
        if Robot_pos is not None:
            planned.cartesian.pos.x = Robot_pos.x + pos[2]
            planned.cartesian.pos.y = Robot_pos.y + pos[0]
            planned.cartesian.pos.z = Robot_pos.z - pos[1]
            planned.cartesian.euler.x=0
...
while True:
        ...
        for face in faces:
            ...
            try:
                if keyboard.is_pressed('h'):
                    ...
                    cv2.putText(img, 'CALIBRATION DONE', (30, 100), font, 2, (0,0,0), 3)
                    time.sleep(1)
            except:
                print('Wrong Key')
            ...
            if is_calibration_done == True:
                ...
                if keyboard.is_pressed('r'):
                    z_cal = 0
                    is_calibration_done = False
                    cv2.putText(img, 'CALIBRATION RESET', (30, 100), font, 2, (0,0,0), 3)
                    pos_rob = [0,0,0]
                    time.sleep(1)
                ...
                # print('X:',pos_rob[2],'; Y:',pos_rob[1],' Z:',pos_rob[0])
    ...
    EGM1.receive_from_robot()

    EGM1.send_to_robot(pos_rob)
